...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('7.3.9', '%s?%s');
    }
    ...
    {
        return $this->services['codeages_plugin.dict_collector'] = new \Codeages\PluginBundle\System\DictCollector(array(0 => ($this->targetDirs[4].'\\src\\Topxia\\WebBundle/Resources/config/dict.yml')), __DIR__, false);
    }
    ...
    {
        return $this->services['codeages_plugin.theme.file_locator'] = new \Codeages\PluginBundle\Locator\ThemeFileLocator($this->get('kernel'), ($this->targetDirs[3].'/Resources'));
    }
    ...
    {
        return $this->services['doctrine.entity_manager.driver.yaml'] = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/../vendor/bshaffer/oauth2-server-bundle/OAuth2/ServerBundle/Resources/config/doctrine') => 'OAuth2\\ServerBundle\\Entity'));
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler(($this->targetDirs[3].'\\logs/prod.log'), 100, true, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.logs_dir' => ($this->targetDirs[3].'\\logs'),
            ...
            'doctrine.config_paths' => array(
                'D:\\MyProject\\php_project\\edusoho\\app/../vendor/bshaffer/oauth2-server-bundle/OAuth2/ServerBundle/Resources/config/doctrine' => 'OAuth2\\ServerBundle\\Entity',
            ),
            ...
            'topxia.disk.upgrade_dir' => ($this->targetDirs[3].'/data/upgrade'),
            ...
            'router.resource' => ($this->targetDirs[3].'/config/routing.yml'),
