...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['biz'] = new \Codeages\Biz\Framework\Context\Biz(array('debug' => true, 'db.options' => array('dbname' => 'edusoho', 'user' => 'root', 'password' => 'root', 'host' => '127.0.0.1', 'port' => 3306, 'driver' => 'pdo_mysql', 'charset' => 'UTF8'), 'root_directory' => ($this->targetDirs[3].'/../'), 'cache_directory' => __DIR__, 'log_directory' => ($this->targetDirs[3].'\\logs'), 'plugin.directory' => ($this->targetDirs[3].'/../plugins'), 'plugin.config_file' => ($this->targetDirs[3].'/config/plugin_installed.php')));
    }
    ...
    {
        return $this->services['codeages_plugin.dict_collector'] = new \Codeages\PluginBundle\System\DictCollector(array(0 => ($this->targetDirs[4].'\\src\\Topxia\\WebBundle/Resources/config/dict.yml')), __DIR__, true);
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler(($this->targetDirs[3].'\\logs/dev.log'), 100, true, NULL);
    }
